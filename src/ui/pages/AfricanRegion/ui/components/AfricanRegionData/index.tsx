...
export const AfricanRegionData = () => {
  const { error, loading, regionData } = useRegionData("Africa");

  const router = useRouter();
  const { setSelectedCountry } = useCountryContext(); // Use the context to set the selected country
      ...
      {regionData &&
        regionData.map((country) => (
          <Box
            ...
            onClick={() => handleCardClick("Africa", country)} // Add click handler here
          >
            <Card
              sx={{
